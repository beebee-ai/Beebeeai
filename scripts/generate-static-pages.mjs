...
const pages = [
  ...
  },
  {
    ...
    body: `<main><h1>BEEBEE AI 证书查询</h1><p>BEEBEE AI 证书用于记录学习者参与的实训营、完成的学习过程与项目成果。在线查询能力正在完善中。</p><section><h2>证书记录的信息</h2><ul><li>参与的实训营与学习路线</li><li>完成的学习阶段与项目实践</li><li>证书编号对应的官方记录</li></ul><p>如需人工核验，请将证书编号与持证人姓名发送至 <a href="mailto:service@beebee.ai">service@beebee.ai</a>。</p></section></main>`,
  ...
  {
    path: 'youth-ai-training', title: '青少年 AI 实训营｜BEEBEE AI ALPHA',
    description: '面向 12–19 岁青少年的项目制 AI 实训，通过真实任务训练提问、AI 协作、工作流搭建与作品表达能力。',
    body: `<main><h1>青少年 AI 实训营</h1><p>ALPHA 让 12–19 岁青少年围绕真实问题完成可展示、可复盘的 AI 项目。</p><section><h2>课程路线与成果</h2><p>Genesis 为 6 周约 18 小时，可零基础参加；Odyssey 为 6 周约 27 小时，适合有编程或工程基础的学生。学习成果包括 AI 项目、问题拆解过程与作品展示。</p><p><a href="https://bee-alpha.com/">进入 ALPHA 实训营网站</a></p></section><section><h2>青少年没有编程基础可以参加 AI 实训营吗？</h2><p>可以。Genesis 从提问、任务拆解和 AI 工具协作开始，不要求一开始编写复杂代码。</p><h2>青少年 AI 实训营结束后能获得什么？</h2><p>学员会完成一个能够展示和复盘的真实 AI 项目，并建立持续解决问题的学习方法。</p></section></main>`,
  ...
  {
    path: 'university-ai-project-training', title: '大学生 AI 项目实训｜BEEBEE AI BETA',
    description: '面向大学生、研究生、职场人士与工程学习者的 BETA 项目实训，训练 AI 产品、全栈实现与市场验证能力。',
    body: `<main><h1>大学生与职场人士 AI 项目实训</h1><p>BETA 围绕真实需求完成 AI Native 产品，把想法、工程实现和市场验证连接成一次完整交付。</p><section><h2>课程路线与成果</h2><p>Galaxy、Cosmos、Infinity 分别约 15、24、36 小时，覆盖 AI 产品设计、全栈工程、RAG、Agent 与市场验证。项目成果可用于作品集、申请或面试展示。</p><p><a href="https://bee-beta.com/">进入 BETA 实训营网站</a></p></section><section><h2>大学生如何通过项目提升 AI 能力？</h2><p>从真实需求出发，完成问题定义、原型、工程实现、测试与展示，比只学习工具功能更容易形成可迁移能力。</p><h2>BETA AI 项目实训适合谁？</h2><p>适合希望完成 AI 产品或工程交付，并把成果用于学习、求职或职业发展的成年人。</p></section></main>`,
  ...
  },
  {
    ...
    description: '了解如何通过提出好问题、拆解任务、AI 协作、真实项目和持续复盘，系统提升可迁移的 AI 能力。',
    body: `<main><h1>如何系统提升 AI 能力</h1><p>真正的 AI 能力不只是会使用某个工具，而是能定义问题、组织协作、验证结果，并把想法交付为作品。</p><section><h2>项目制 AI 学习路径</h2><ol><li>定义问题与可验证目标</li><li>拆解 AI 可以协作的步骤</li><li>在真实项目中训练工具、产品与工程能力</li><li>通过展示和复盘沉淀方法</li></ol><p><a href="https://beebee.ai/#platform">查看实训营与企业服务</a></p></section><section><h2>如何提升 AI 能力，而不只是学会使用工具？</h2><p>选择一个真实问题，完成定义、拆解、AI 协作、验证和交付的完整闭环。</p><h2>零基础学习 AI 应该从哪里开始？</h2><p>从提出好问题、拆解简单任务和完成小型项目开始，再根据目标进入 ALPHA 或 BETA 的系统路线。</p></section></main>`,
...
const intentFaq = {
  'youth-ai-training': [['青少年没有编程基础可以参加 AI 实训营吗？', '可以。Genesis 从提问、任务拆解和 AI 工具协作开始，不要求一开始编写复杂代码。'], ['青少年 AI 实训营结束后能获得什么？', '学员会完成一个能够展示和复盘的真实 AI 项目，并建立持续解决问题的学习方法。']],
  'university-ai-project-training': [['大学生如何通过项目提升 AI 能力？', '从真实需求出发，完成问题定义、原型、工程实现、测试与展示，比只学习工具功能更容易形成可迁移能力。'], ['BETA AI 项目实训适合谁？', '适合希望完成 AI 产品或工程交付，并把成果用于学习、求职或职业发展的成年人。']],
  ...
  'how-to-improve-ai-skills': [['如何提升 AI 能力，而不只是学会使用工具？', '选择一个真实问题，完成定义、拆解、AI 协作、验证和交付的完整闭环。'], ['零基础学习 AI 应该从哪里开始？', '从提出好问题、拆解简单任务和完成小型项目开始，再根据目标进入 ALPHA 或 BETA 的系统路线。']],
};
