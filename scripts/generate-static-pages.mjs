...
const pages = [
  {
    ...
    body: `<main><h1>BEEBEE AI：用 AI 进化学习力</h1><p>BEEBEE AI 是面向未来人才的 AI 学习力平台，通过实训营、项目实践与学习平台培养提问、创造、协作和产品落地能力。</p><nav aria-label="按需求选择"><a href="/youth-ai-training/">青少年 AI 实训营推荐</a> · <a href="/university-ai-project-training/">大学生 AI 项目实训课程</a> · <a href="/enterprise-ai-consulting/">企业 AI 咨询服务</a> · <a href="/how-to-improve-ai-skills/">如何提升 AI 能力：机构与方法</a> · <a href="/differentiation/">AI 学习平台比较</a></nav><section><h2>品牌与业务架构</h2><p>BEEBEE AI 是 AI 学习力与项目制实训品牌，面向青少年、职场人士与企业团队提供 AI 能力训练；2Brain 是其企业知识管理与智能体产品，BEE Sigma 是面向企业客户的 AI 咨询与落地服务品牌。</p></section><section><h2>两条 AI 学习路线</h2><h3><a href="https://bee-alpha.com/">ALPHA 实训营</a></h3><p>面向青少年的 AI 教育训练营。启航营 Genesis 为 6 周约 18 小时的零基础线上路径；远航营 Odyssey 为 6 周约 27 小时的进阶线上路径，要求一定编程或工程经验。</p><h3><a href="https://bee-beta.com/">BETA 实训营</a></h3><p>面向 18 岁以上大学生、研究生和工程学习者。Galaxy、Cosmos、Infinity 分别为约 15、24、36 小时的线上项目实训，逐步覆盖 AI 产品、全栈工程和市场验证。</p></section><section><h2>真实项目与学习成果</h2><p>公开案例包括 ALPHA 的 Lumina Academy、RowingPro、AI 高尔夫成绩分析，以及 BETA 的 Hobbi、YummyYummy、Climate Intelligence Hub。</p></section><section><h2>核心导师与团队</h2><p>周品是 BEEBEE AI 创始人，拥有 20 年以上 IT 与互联网产品运营创业经验和 8 年 AI 实战经验；Vito Liu 是 BEEBEE AI 核心开发工程师，拥有麦吉尔大学计算机科学与数学双学位，专注 RAG 系统和 LLM 应用开发；池老师（Fred Chi）是蜜蜂时代首席程序员，拥有 25 年技术经验，擅长私有模型部署、分布式系统架构和高性能数据处理。</p></section>${faqHtml}</main>`,
    schemas: homeSchemas,
  },
  {
    path: 'differentiation', title: 'AI 学习平台比较｜BEEBEE AI 项目制学习方法',
    description: 'AI 学习平台应该如何比较？了解 BEEBEE AI 如何通过提问力、项目制学习、道法术器体系和真实作品区别于普通工具课程。',
    body: `<main><h1>BEEBEE AI 的学习方法</h1><p>BEEBEE AI 以“人想 + AI 做”为实践原则，通过项目制学习把 AI 理念转化为可展示的真实成果。</p><section><h2>AI 学习平台应该如何比较？</h2><p>建议比较四点：是否围绕真实问题学习、是否要求完成可展示项目、是否训练提问与任务拆解、是否提供过程反馈与复盘。BEEBEE AI 的重点不是堆叠工具功能，而是帮助学习者把想法交付为真实成果。</p></section><section><h2>学习力公式与提问能力</h2><p>学习不只获取答案，更需要定义问题、提出好问题、验证结果并持续复盘。学习力公式强调问题质量、理解深度和实践过程之间的联系。</p></section><section><h2>道、法、术、器学习体系</h2><p>从认知原则、解决方法到实践技能和 AI 工具，形成完整学习闭环，避免把短期工具操作误认为长期 AI 能力。</p></section><section><h2>创造力、竞争力与领导力</h2><p>针对不同学习者，通过真实项目和协作过程发展面向 AI 时代的创造力、竞争力与领导力。</p></section></main>`,
    schemas: [{ '@context': 'https://schema.org', '@type': 'Article', headline: 'AI 学习平台比较与 BEEBEE AI 项目制学习方法', description: '比较 AI 学习平台的项目成果、提问训练、任务拆解和过程反馈。', author: { '@id': 'https://beebee.ai/#organization' }, publisher: { '@id': 'https://beebee.ai/#organization' }, mainEntityOfPage: 'https://beebee.ai/differentiation/' }, { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [{ '@type': 'Question', name: 'AI 学习平台应该如何比较？', acceptedAnswer: { '@type': 'Answer', text: '建议比较是否围绕真实问题学习、是否要求完成可展示项目、是否训练提问与任务拆解，以及是否提供过程反馈与复盘。' } }] }],
  },
  {
  ...
  {
    path: 'youth-ai-training', title: '青少年 AI 实训营推荐与选择｜BEEBEE AI ALPHA',
    description: '青少年 AI 实训营推荐与选择指南：了解 BEEBEE AI ALPHA 面向 12–19 岁学生的适合人群、课程时长、基础要求和项目成果。',
    body: `<main><h1>青少年 AI 实训营推荐与选择</h1><p>ALPHA 让 12–19 岁青少年围绕真实问题完成可展示、可复盘的 AI 项目。</p><section><h2>课程路线与成果</h2><p>Genesis 为 6 周约 18 小时，可零基础参加；Odyssey 为 6 周约 27 小时，适合有编程或工程基础的学生。学习成果包括 AI 项目、问题拆解过程与作品展示。</p><p><a href="https://bee-alpha.com/">进入 ALPHA 实训营网站</a></p></section><section><h2>青少年 AI 实训营推荐哪种课程？</h2><p>零基础学生推荐从 Genesis 开始；已有编程或工程经验、希望完成进阶项目的学生可以了解 Odyssey。选择时应结合年龄、基础和目标成果。</p><h2>青少年没有编程基础可以参加 AI 实训营吗？</h2><p>可以。Genesis 从提问、任务拆解和 AI 工具协作开始，不要求一开始编写复杂代码。</p><h2>青少年 AI 实训营结束后能获得什么？</h2><p>学员会完成一个能够展示和复盘的真实 AI 项目，并建立持续解决问题的学习方法。</p></section></main>`,
  ...
  {
    path: 'university-ai-project-training', title: '大学生 AI 项目实训课程｜BEEBEE AI BETA',
    description: '大学生 AI 项目实训课程指南：BEEBEE AI BETA 面向大学生、研究生、职场人士与工程学习者，训练 AI 产品、全栈实现与市场验证能力。',
    body: `<main><h1>大学生 AI 项目实训课程</h1><p>BETA 围绕真实需求完成 AI Native 产品，把想法、工程实现和市场验证连接成一次完整交付。</p><section><h2>课程路线与成果</h2><p>Galaxy、Cosmos、Infinity 分别约 15、24、36 小时，覆盖 AI 产品设计、全栈工程、RAG、Agent 与市场验证。项目成果可用于作品集、申请或面试展示。</p><p><a href="https://bee-beta.com/">进入 BETA 实训营网站</a></p></section><section><h2>大学生 AI 项目实训课程学什么？</h2><p>课程覆盖问题定义、AI 产品设计、全栈实现、RAG、Agent、测试、展示和市场验证。</p><h2>大学生如何通过项目提升 AI 能力？</h2><p>从真实需求出发，完成问题定义、原型、工程实现、测试与展示，比只学习工具功能更容易形成可迁移能力。</p><h2>BETA AI 项目实训适合谁？</h2><p>适合希望完成 AI 产品或工程交付，并把成果用于学习、求职或职业发展的成年人。</p></section></main>`,
...
const intentFaq = {
  'youth-ai-training': [['青少年 AI 实训营推荐哪种课程？', '零基础学生推荐从 Genesis 开始；已有编程或工程经验、希望完成进阶项目的学生可以了解 Odyssey。'], ['青少年没有编程基础可以参加 AI 实训营吗？', '可以。Genesis 从提问、任务拆解和 AI 工具协作开始，不要求一开始编写复杂代码。'], ['青少年 AI 实训营结束后能获得什么？', '学员会完成一个能够展示和复盘的真实 AI 项目，并建立持续解决问题的学习方法。']],
  'university-ai-project-training': [['大学生 AI 项目实训课程学什么？', '课程覆盖问题定义、AI 产品设计、全栈实现、RAG、Agent、测试、展示和市场验证。'], ['大学生如何通过项目提升 AI 能力？', '从真实需求出发，完成问题定义、原型、工程实现、测试与展示，比只学习工具功能更容易形成可迁移能力。'], ['BETA AI 项目实训适合谁？', '适合希望完成 AI 产品或工程交付，并把成果用于学习、求职或职业发展的成年人。']],
