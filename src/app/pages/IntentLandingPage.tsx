...
const pages = {
  youth: {
    ...
    questions: [['青少年 AI 实训营课程怎么选？', '零基础学生推荐从 Genesis 开始；已有编程或工程经验、希望完成进阶项目的学生可以了解 Odyssey。选择时应结合年龄、基础和目标成果。'], ['青少年没有编程基础可以参加 AI 实训营吗？', '可以。Genesis 从提问、任务拆解和 AI 工具协作开始，不要求一开始编写复杂代码。'], ['青少年 AI 实训营结束后能获得什么？', '学员会完成一个能够展示和复盘的真实 AI 项目，并建立持续解决问题的学习方法。']],
  ...
  university: {
    ...
    questions: [['大学生 AI 项目实训应该如何选择？', '先看项目是否来自真实需求、是否覆盖从产品设计到工程实现与验证的完整过程，以及成果能否用于作品集、申请或面试展示。'], ['大学生 AI 项目实训课程学什么？', '课程围绕真实需求，覆盖问题定义、AI 产品设计、全栈实现、RAG、Agent、测试、展示和市场验证。'], ['大学生如何通过项目提升 AI 能力？', '从真实需求出发，完成问题定义、原型、工程实现、测试与展示，比只学习工具功能更容易形成可迁移能力。']],
