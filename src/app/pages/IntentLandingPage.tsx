...
const pages = {
  youth: {
    ...
    questions: [['青少年 AI 实训营课程怎么选？', '零基础学生推荐从 Genesis 开始；已有编程或工程经验、希望完成进阶项目的学生可以了解 Odyssey。选择时应结合年龄、基础和目标成果。'], ['青少年 AI 实训营推荐哪种路线？', '希望建立 AI 兴趣和基础方法的学生可从 Genesis 开始；已有编程或工程经验、希望挑战更完整项目的学生可选择 Odyssey。'], ['青少年没有编程基础可以参加 AI 实训营吗？', '可以。Genesis 从提问、任务拆解和 AI 工具协作开始，不要求一开始编写复杂代码。'], ['青少年 AI 实训营结束后能获得什么？', '学员会完成一个能够展示和复盘的真实 AI 项目，并建立持续解决问题的学习方法。']],
