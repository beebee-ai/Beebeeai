...
const pages = {
  youth: {
    ...
    questions: [['青少年没有编程基础可以参加 AI 实训营吗？', '可以。Genesis 从提问、任务拆解和 AI 工具协作开始，不要求一开始编写复杂代码。'], ['青少年 AI 实训营结束后能获得什么？', '学员会完成一个能够展示和复盘的真实 AI 项目，并建立持续解决问题的学习方法。']],
    cta: '进入 ALPHA 实训营网站', href: 'https://bee-alpha.com/',
  },
  university: {
    path: '/university-ai-project-training/',
    eyebrow: 'BETA · AI PROJECT TRAINING',
    title: '大学生与职场人士 AI 项目实训',
    ...
    questions: [['大学生如何通过项目提升 AI 能力？', '从真实需求出发，完成问题定义、原型、工程实现、测试与展示，比只学习工具功能更容易形成可迁移能力。'], ['BETA AI 项目实训适合谁？', '适合希望完成 AI 产品或工程交付，并把成果用于学习、求职或职业发展的成年人。']],
  ...
  skills: {
    ...
    questions: [['如何提升 AI 能力，而不只是学会使用工具？', '选择一个真实问题，完成定义、拆解、AI 协作、验证和交付的完整闭环，能力会比单独记忆工具功能更稳定。'], ['零基础学习 AI 应该从哪里开始？', '从提出好问题、拆解简单任务和完成小型项目开始，再根据目标进入 ALPHA 或 BETA 的系统路线。']],
